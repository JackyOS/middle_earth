...
@WebServlet("/admin/promotions/createAxB.admin")
public class CreatePromotionAxBServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/views/admin/promotions/createAxB.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		for (String attraction : attractionsFree) {
			int id = AttractionDAOImpl.findId(attraction);
			aFree.add(attractionService.find(id));
			}	
				
		// crea una promocion me la guarda en el dao
		PromocionAxB promotion = promotionService.createPromocionAxB(name,type, a, aFree, description, image);
		...
		if (promotion.isValid()) { // pregunta si es valida
			...
			RequestDispatcher dispatcher = getServletContext()
					.getRequestDispatcher("/views/admin/promotions/createAxB.jsp");
			dispatcher.forward(req, resp);
		}
