...
@WebServlet("/admin/promotions/createAbsoluta.admin")
public class CreatePromotionAbsolutaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/views/admin/promotions/createAbsoluta.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		PromocionAbsoluta promotion = promotionService.createPromoAbsoluta(name,type, cost, a, description, image);
		...
		if (promotion.isValid()) { // pregunta si es valida
			...
			RequestDispatcher dispatcher = getServletContext()
					.getRequestDispatcher("/views/admin/promotions/createAbsoluta.jsp");
			dispatcher.forward(req, resp);
		}
